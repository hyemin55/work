...
CREATE TABLE `work_dept` (
  `w_pct_time` int NOT NULL,
  `p_ssn` varchar(12) NOT NULL,
  `d_no` int NOT NULL,
  PRIMARY KEY (`p_ssn`,`d_no`),
  KEY `d_no` (`d_no`),
  CONSTRAINT `work_dept_ibfk_1` FOREIGN KEY (`p_ssn`) REFERENCES `professor` (`p_ssn`),
  CONSTRAINT `work_dept_ibfk_2` FOREIGN KEY (`d_no`) REFERENCES `department` (`d_no`)
